...
### Executive Dashboard
Show the live Radient AI dashboard with current-state operational metrics, utilization, staffing, and AI insights.
<p align="center">
  <img src="images/dashboard.png" width="850" alt="Executive Dashboard Screenshot">
</p>

### AI Scenario Explorer
Show the Scenario Explorer interface where users can ask Radient to evaluate future-state operational scenarios.
<p align="center">
  <img src="images/scenario_explorer.png" width="850" alt="AI Scenario Explorer Screenshot">
</p>

### Ranked Recommendations
Show the top recommendations generated by the Scenario Explorer, including financial, throughput, burnout, and feasibility tradeoffs.
<p align="center">
  <img src="images/recommendations.png" width="850" alt="Ranked Recommendations Screenshot">
</p>

### Remote A2A Agent Evidence
Show proof that the deployed backend is calling the remote Scenario Explorer Agent through A2A/JSON-RPC.
<p align="center">
  <img src="images/a2a_logs.png" width="850" alt="A2A Agent Logs Screenshot">
</p>
...
> **"Radient AI separates deterministic operational calculations from Gemini-powered explanation. The Scenario Explorer runs as an independent A2A-compatible Cloud Run agent."**
